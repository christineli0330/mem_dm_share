...
```{r}
#Load memorability data
dat.w = read.csv("C:/Users/Christine/Box Sync/data/mem_dm_share/Exp2B.csv")
...
hist.mem.word
ggsave('C:/Users/Christine/Box Sync/data/mem_dm_all_results/visualization/hist_word.png', width = 8, height = 6, units = 'in')
```
